  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <section className="relative flex flex-col items-center justify-center bg-gradient-to-r from-gray-800 to-gray-600 text-white py-20 px-4">
        <h1 className="text-5xl font-extrabold mb-6 text-center">About Finquill</h1>
        ...
        <FaFeatherAlt className="text-yellow-400 text-9xl mb-10" />
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-800 mb-4">Why Choose Finquill?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-4 lg:px-16">
          <div className="bg-gray-100 p-8 rounded-lg shadow-lg text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-2">Client-Centric</h3>
            <p className="text-gray-600">Finquill puts you and your clients first, with streamlined invoicing that enhances communication and transparency.</p>
          </div>
          <div className="bg-gray-100 p-8 rounded-lg shadow-lg text-center">
            <FaRocket className="text-green-500 text-6xl mb-4" />
            <h3 className="text-2xl font-bold text-gray-800 mb-2">Innovative Tools</h3>
            <p className="text-gray-600">Our platform is built using cutting-edge technology to provide a seamless invoicing experience that keeps you ahead.</p>
          </div>
          <div className="bg-gray-100 p-8 rounded-lg shadow-lg text-center">
            <FaCogs className="text-yellow-500 text-6xl mb-4" />
            <h3 className="text-2xl font-bold text-gray-800 mb-2">Automated Efficiency</h3>
            <p className="text-gray-600">Save time with automated reminders, recurring invoices, and financial tracking, so you can focus on growing your business.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-gray-800 to-gray-600 text-center text-white px-4">
        <h2 className="text-4xl font-bold mb-4">Ready to Elevate Your Invoicing?</h2>
